...
{
    public class AnnotationRepository : MySqlRepository, IAnnotationRepository
    {
        public AnnotationRepository(GoodNewsDBContext db) : base(db) { }
        
        public async Task<List<SessionAnnotation>> GetSessionAnnotations(string sessionId)
        {
